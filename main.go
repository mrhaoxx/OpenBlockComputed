...
func initLedger(contract *client.Contract) {
	...
	_, err := contract.SubmitTransaction("CreateRootUser")
...
func getAllAssets(contract *client.Contract) {
	...
	evaluateResult, err := contract.EvaluateTransaction("ListComputeRes")
	if err != nil {
...
func createAsset(contract *client.Contract) {
	...
	_, err := contract.SubmitTransaction("CreateComputeRes", assetId)
	if err != nil {
...
func checkErr(err error, contract *client.Contract) {
